...
class AbiImplTest : DescribeSpec({
    context("Type.fromTypeName") {
        ...
        it("uint256[]") { parse() shouldBe ArrayType("uint256", null, "uint256".type) }
        it("uint256[][]") { parse() shouldBe ArrayType("uint256[]", null, ArrayType("uint256", null, "uint256".type)) }
        it("uint256[2]") { parse() shouldBe ArrayType("uint256", 2, "uint256".type) }
        it("uint256[0]") { parse() shouldBe ArrayType("uint256", 0, "uint256".type) }
